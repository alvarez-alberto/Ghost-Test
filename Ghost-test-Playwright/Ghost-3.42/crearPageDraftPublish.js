...
(async () => {
  ...
  for (const browserType of ['chromium']){
    ...
    console.log('1. Incio');
	await page.screenshot({path: './resultado/crearPageDraftPublish/1. Inicio.png'});
    
	await page.type('#ember8', user);
    await page.type('#ember10', password);
	
	console.log('2.Ingresar datos para autenticarse')
	await page.screenshot({path:'./resultado/crearPageDraftPublish/2.Datos_autenticarse.png'});
    await page.click('#ember12');
	
	await new Promise(r => setTimeout(r, 7000));
	console.log('3. Autenticado con Exito');
    await page.screenshot({path:'./resultado/crearPageDraftPublish/3.Autenticacion_exitosa.png'});
	
	await page.click('text=Pages');
	console.log('4. Ingresar a opción de menú pages');
	await new Promise(r => setTimeout(r, 2000));
	await page.screenshot({path:'./resultado/crearPageDraftPublish/4.Ingreso_pages.png'});
	
	await page.click('text=New page');
	console.log('5. Nueva pagina');
	await new Promise(r => setTimeout(r, 2000));
	await page.screenshot({path:'./resultado/crearPageDraftPublish/5.Nueva_pagina.png'});
	...
	await new Promise(r => setTimeout(r, 2000));
	await page.screenshot({path:'./resultado/crearPageDraftPublish/6.Titulo.png'});

	await page.click(".blue.link.fw4.flex.items-center.ember-view");
	await new Promise(r => setTimeout(r, 4000));
	await page.click(".blue.link.fw4.flex.items-center.ember-view");
	console.log('7. Ingreso page');
	await page.screenshot({path:'./resultado/crearPageDraftPublish/7.Ingreso_page.png'});
	...
	await new Promise(r => setTimeout(r, 2000));
	await page.screenshot({path:'./resultado/crearPageDraftPublish/8.draft_pages.png'});

    await page.click(".gh-list > li:nth-child(2) > a:nth-child(2)");
    console.log('9. Ingresar a la pagina en borrador');
	await new Promise(r => setTimeout(r, 2000));
    await page.screenshot({path:'./resultado/crearPageDraftPublish/9.draft_page.png'});
	...
	await page.screenshot({path:'./resultado/crearPageDraftPublish/10.Publicar_Page.png'});
	
    await page.click(".blue.link.fw4.flex.items-center.ember-view");
	console.log('11. Ingresar a la lista de pages');
	await new Promise(r => setTimeout(r, 2000));
	await page.screenshot({path:'./resultado/crearPageDraftPublish/11.Ingreso_page.png'});
	
    await page.click("div.gh-contentfilter-menu.gh-contentfilter-type > div.ember-view.ember-basic-dropdown-trigger.ember-power-select-trigger.gh-contentfilter-menu-trigger");
    await page.click(".ember-power-select-options > li:nth-child(3)");
    console.log('12. Ingresar a la lista de paginas publicadas');
	await new Promise(r => setTimeout(r, 2000));
	await page.screenshot({path:'./resultado/crearPageDraftPublish/12.publish_pages.png'});
